 ...
 * @LastEditTime : 2020-08-27 17:54:54
 */
...
const shenzhen = fromLonLat([113.562447026, 22.2569146461])
      ...
      var map = new Map({
        ...
        layers: [
          new TileLayer({
            ...
            preload: 4,
            source: new XYZ({
              attributions:'<a href="https://www.ilng.cn/" target="_blank">&copy; MapTiler</a> <a href="https://www.ilng.cn/" target="_blank">&copy; ILNG</a>',
              url: 'http://192.168.0.71:5000/TileFiles/vtile/{z}/{x}/{y}.png?apikey=1234',
            })
          }),
          vectorLayer,
        ],
      ...
      fetch('/zhgasmap.json')
        ...
        .then((data) => {
          ...
          var styleFunction = function (feature) {
            console.log("NetworkMap -> styleFunction -> feature.getGeometry().getType()", feature.getGeometry().getType())
          ...
          // })
           var vectorSource = new VectorSource({
              features: new GeoJSON().readFeatures(geojsonObject, {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'})
          });
