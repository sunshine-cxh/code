 ...
 * @LastEditors  : hezihua
 * @LastEditTime : 2020-09-04 14:23:31
 */
...
export default class extends Component {
  ...
  render() {
    let { basicDataAdd } = this.props
    let { filePageData } = basicDataAdd
    let { fileLoading } = this.state
    let columnsFile = createColumnsFile(this)
    let action = getAction(130)
