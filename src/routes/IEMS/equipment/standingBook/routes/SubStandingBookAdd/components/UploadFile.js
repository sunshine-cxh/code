 ...
 * @LastEditors  : hezihua
 * @LastEditTime : 2020-09-04 14:22:59
 */
...
export default class extends Component {
  ...
  deleteFn = (record) => {
    ...
    dispatch({
      type: 'standingBookAdd/deleteFile',
      payload: {
        record,
      },
    })
  ...
  render() {
    let { standingBookAdd } = this.props
    let { filePageData } = standingBookAdd
