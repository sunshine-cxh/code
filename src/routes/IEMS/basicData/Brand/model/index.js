...
export default modelEnhance({
  ...
  effects: {
    ...
    *init({ payload }, { call, put, select }) {
      let { pageData } = yield select((state) => state.brand)
      yield put.resolve({
        type: 'getPageInfo',
    ...
    *getPageInfo({ payload }, { call, put, select }) {
      const { parameters } = yield select((state) => state.brand)
      ...
      yield put.resolve({
        ...
        payload: {
          valueField: 'pageData',
          url: `${apiPrefix}/brand/getlistdata`,
          pageInfo: pageData,
          ...data,
        },
      })
    ...
    *delete({ payload }, { call, put, select }) {
      ...
      yield put.resolve({
        ...
        payload: {
          notice: true,
          url: `${apiPrefix}/brand/delete?id=${id}`,
        },
      })
