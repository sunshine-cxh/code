...
export default modelEnhance({
  ...
  effects: {
    ...
    *init({ payload }, { call, put, select }) {
      let { pageData } = yield select((state) => state.unit)
      yield put.resolve({
        type: 'getPageInfo',
    ...
    *getPageInfo({ payload }, { call, put, select }) {
      const { parameters } = yield select((state) => state.unit)
      ...
      yield put.resolve({
        ...
        payload: {
          valueField: 'pageData',
          url: `${apiPrefix}/unit/getlistdata`,
          pageInfo: pageData,
          ...data,
        },
      })
    ...
    *delete({ payload }, { call, put, select }) {
      ...
      yield put.resolve({
        ...
        payload: {
          notice: true,
          url: `${apiPrefix}/unit/delete?id=${id}`,
        },
      })
