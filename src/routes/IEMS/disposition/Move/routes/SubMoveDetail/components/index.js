 ...
 * @LastEditors  : hezihua
 * @LastEditTime : 2020-09-03 17:41:33
 */
...
export default class moveDetail extends BaseComponent {
  state = {
    fileLoading: false,
  }
  componentDidMount() {
  ...
  render() {
    ...
    const {
      moveDetail: { moveTableList, checkHis, filePageData },
      loading,
    } = this.props
