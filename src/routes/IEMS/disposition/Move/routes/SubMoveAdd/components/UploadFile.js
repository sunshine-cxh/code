 ...
 * @LastEditors  : hezihua
 * @LastEditTime : 2020-09-09 17:13:37
 */
...
@connect(({ moveAdd, loading, standingBook }) => ({
  moveAdd,
...
export default class extends Component {
  ...
  render() {
    let { moveAdd } = this.props
    let { filePageData } = moveAdd
