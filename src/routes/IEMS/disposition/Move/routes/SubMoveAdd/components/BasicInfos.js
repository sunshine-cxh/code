...
class BasicForm extends Component {
  ...
  render() {
    const { moveAdd, form, dispatch } = this.props
    const { details, approvalRow, organizationTree } = moveAdd
    ...
    return (
      <section className="block-wrap form-wrap">
        ...
        <Form {...formItemLayout}>
          ...
          <Item label="调入部门">
            {getFieldDecorator('registerCallDepart', {
              rules: [
                {
                  required: true,
                  message: '请选择调入部门',
              ...
              initialValue: details.registerCallDepart,
            })(<TreeSelect width="100%" placeholder="调入部门" treeData={organizationTree} />)}
          </Item>
          <Item label="审批人">
