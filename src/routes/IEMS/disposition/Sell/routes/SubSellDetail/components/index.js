...
@connect(({ sellDetail, loading }) => ({
  sellDetail,
  loading: loading.models.sellDetail,
}))
export default class sellDetail extends BaseComponent {
  state = {
    fileLoading: false
  }
  componentDidMount() {
  ...
  render() {
    ...
    const {
      sellDetail: { moveTableList, checkHis, filePageData },
      loading,
    } = this.props
