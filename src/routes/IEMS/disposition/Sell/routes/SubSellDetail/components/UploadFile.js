 ...
 * @LastEditors  : hezihua
 * @LastEditTime : 2020-09-04 14:16:53
 */
...
@connect(({ sellDetail, loading, standingBook }) => ({
  sellDetail,
  loading: loading.models.sellDetail,
  standingBook,
}))
export default class extends Component {
  ...
  render() {
    let { sellDetail } = this.props
    let { filePageData } = sellDetail
