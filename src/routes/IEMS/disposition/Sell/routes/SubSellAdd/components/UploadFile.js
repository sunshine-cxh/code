 ...
 * @LastEditors  : hezihua
 * @LastEditTime : 2020-09-04 14:22:48
 */
...
@connect(({ sellAdd, loading, standingBook }) => ({
  sellAdd,
...
export default class extends Component {
  ...
  render() {
    let { sellAdd } = this.props
    let { filePageData } = sellAdd
