 ...
 * @LastEditTime : 2020-05-22 15:16:35
 */
...
class TransientCalculation extends BaseComponent {
  ...
  componentDidMount() {
    // this.props.dispatch({
    //   type: 'TransientCalculation/getInitData',
    //   payload: {},
    // })
  }
  ...
  render() {
    ...
    let selectQiyuanProps = {
      options: format.selectDictFormat(
      ...
      onChange: (value, option) => {
        ...
        for (let i = 0; i < resultData.length; i++) {
          if (resultData[i].NodeId === value) {
            SGSolverProfileList =
              resultData[i].SGSolverProfileList[0].NodeProfileList
          }
        }
        dispatch({
    ...
    return (
      <Layout className="full-layout page TransientCalculation-page">
        <Layout.Content>
          <Panel header={null}>
                  ...
                  <Col>
                    ...
                    >
                      ...
                      >
                        ...
                        {/* <Geom
                          type="line"
                          position="SystemLinepackTime*value"
                          opacity={1} //透明度
                          color="type"
                          shape="smooth"
                          size={1}
