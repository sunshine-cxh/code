 ...
 * @LastEditTime : 2020-06-03 16:33:06
 */
...
class SteadyStateCalculation extends BaseComponent {
  ...
  render() {
    ...
    console.log(
      'SteadyStateCalculation -> render -> tabsActiveKeyKey',
      tabsActiveKeyKey
    )
    ...
    return (
      <Layout className="full-layout page transient-calculation">
        <Content>
          {loading && !loaded ? (
            <Panel header={null}>
              <div className="flexbox flex-justify-content-center loading">
                模型加载中...
              </div>
            </Panel>
          ) : (
            <Panel header={null}>
                          ...
                          <Item key={i} label={item.NodeName}>
                            ...
                            >
                              <span className="flexbox flex-align-items-center flex-1">
                                <Radio value={`Known Pressure-${item.NodeId}`}>
                                  压力
                                </Radio>
                                <Input
                                  width="100%"
                                  placeholder="压力"
                                  disabled={
                                    item.NodeStatus !== 'Known Pressure'
                                  }
                              ...
                              <span className="flexbox flex-align-items-center flex-1">
                                <Radio value={`Known Flow-${item.NodeId}`}>
                                  流量
                                </Radio>
                                <Input
                                  width="100%"
                        ...
                        <Item key={i} label={item.RegulatorName}>
                          <div className="flexbox flex-align-items-center flex-1">
                            <Input
                              ...
                              suffix="KPa"
                              onChange={(value) =>
                                this.inputDeviceRegulatorChangeHandler(
                                  value,
                                  item.RegulatorName
                                )
                              }
              ...
              <div className="from-wrap">
                <Form
                  className="flexbox flex-wrap-wrap Guest-wrap"
                  {...formItemLayout}
                >
                  {SGSolverGuestList &&
