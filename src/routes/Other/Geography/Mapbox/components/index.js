...
export default class MapboxExample extends React.Component {
      ...
      map: new Mapbox({
        ...
        style: {
          ...
          sources: {
            'osm-tiles': {
              type: 'raster',
              tiles: ['https://mt2.google.cn/vt/lyrs=m&scale=2&hl=zh-CN&gl=cn&x={x}&y={y}&z={z}'],
              tileSize: 256,
            },
          },
          layers: [
  ...
  //渲染
  render() {
    console.log('aaa', this.state.pipLineConfig)

    return (
      <Layout className="full-layout page">
        <Content>
          <Toolbar>
            <Button type="primary2" className="toolbar-item" icon="plus" onClick={this.onAdd}>
              新增
            </Button>
            <Button
              type="primary2"
