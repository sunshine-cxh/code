 ...
 * @LastEditTime : 2020-06-28 14:49:15
 */
    ...
    return (
      <Layout className="full-layout page operate-home-page">
        <Content>
            ...
            <Col md={6}>
              <Panel title="气象预测条件" boxShadow height={390}>
                <div className="forecast-wrap">
                  <Form {...formItemLayout} onSubmit={this.handleSubmitForecast}>
                    ...
                    <Button type="primary3" htmlType="submit" className="forecast-submit-button">
                      计算
                    </Button>
                  </Form>
                </div>
          ...
          <Row gutter={24}>
            <Col span={24}>
              <Panel title="日用用气量趋势表" absoluteTitle allowControls boxShadow height={430}>
          ...
          <Row gutter={24}>
            <Col span={24}>
              <Panel title="月用用气量趋势表" absoluteTitle allowControls boxShadow height={430}>
                <div className="chart-y-tips">用气量（万Nm³）</div>
                <Charts
                  className="chart-wrap"
                  height={400} //图标高度
          ...
          <Row gutter={24}>
            <Col span={24}>
              <Panel title="年用用气量趋势表" absoluteTitle allowControls boxShadow height={430}>
                <div className="chart-y-tips">用气量（万Nm³）</div>
                <Charts
                  className="chart-wrap"
                  height={400} //图标高度
