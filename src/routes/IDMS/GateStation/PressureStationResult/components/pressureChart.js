/*
 * @Descripttion : 调压站运算输出-压力列表
 * @Author       : caojiarong
 * @Date         : 2020-07-01 15:11:37
 * @LastEditors  : caojiarong
 * @LastEditTime : 2020-08-14 11:36:43
 */
...
import {flowColumns,FlowColorList, PressureColorList, colorSet, getFilterName} from './columns'
...
class PressureChart extends BaseComponent {
  ...
  render() {
    ...
    const flowScale = {
      value: {
        alias: '压力(kPa)', // 数据字段的别名，会影响到轴的标题内容
      },
      Time: {
    ...
    return (
      <>
        <Panel title="压力统计" absoluteTitle allowControls boxShadow height={440}>
          <Icon type='pressure' className='chart-icon-pressure'/>
          <div className="chart-y-tips-pressure">压力(kPa)</div>
          <Charts
          ...
          >
            ...
            <Geom
              ...
              color={[
                ...
                (type)=>{
                  ...
                  return PressureColorList[colorIndex]
                }
              ]}
              shape="smooth"
              size={4}
            ...
            <Geom
              ...
              tooltip={['Time*value*type', (Timev, value, type) => {  //格式化显示内容模板
                return {
                  //自定义 tooltip 上显示的 title 显示内容等。
                  item:{
                    fill:'red'
