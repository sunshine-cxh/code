...
export default class PageInfo {
  ...
  // 排序条件 {name: 'asc', age: 'desc'}  asc 升序排列 desc降序排列
  // sorts = {};
   ...
   */
  startPage(pageNum = 1, pageSize = 10, sortField = '', sort = '') {
   ...
   */
  jumpPage(pageNum = 1, pageSize = 10) {
  ...
  send(url, options) {
    const self = this;
    const { pageNum, pageSize, filters, sorts, sort, sortField } = this;
    let data = { pageNum, pageSize, filters, sorts, sort, sortField };
